...
public class BookPanelView {
    ...
    public void setProperty(
        ...
        //set judul buku
        judulBukuText.setFont(new java.awt.Font("Bahnschrift", 0, 18));
        ...
        //set stok
        stokText.setFont(new java.awt.Font("Tahoma", 0, 18));
        ...
        //set harga_jual
        hargaJualText.setFont(new java.awt.Font("Tahoma", 1, 24));
        hargaJualText.setHorizontalAlignment(javax.swing.SwingConstants.TRAILING);
        hargaJualText.setText(String.valueOf(harga_jual));
